...
def generator_numbers(text: str):
        # Знайти всі дійсні числа у тексті за допомогою регулярних виразів
    pattern = r'\b\d+\.\d+\b'
    matches = re.findall(pattern, text)


        # Ітеруємося по знайдених числах і повертаємо їх у вигляді генератора
    for match in matches:
        yield float(match)

def sum_profit(text: str, func: Callable):
        # Використовуємо генератор для отримання всіх чисел з тексту
    numbers = func(text)
...
text = "Загальний дохід працівника складається з декількох частин: 1000.01 як основний дохід, доповнений додатковими надходженнями 27.45 і 324.00 доларів."
totla_income = sum_profit(text, generator_numbers)
print(f"Загальний дохід: {totla_income}")